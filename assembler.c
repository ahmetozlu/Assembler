...
//modified when we discover the address of the label or variable that it uses.
	...
	fp = fopen("Project3assembly.txt","r");
...
//========================================   FIRST PASS  ======================================================
			while (token)
			{
				...
				else if (strcmp(token,"sub")==0)
				{
					...
					op3 = strtok(NULL,"\n\t\r ");
					chch = (op1[0]-48)| ((op2[0]-48)<<6)|((op3[0]-48)<<3);
					program[counter]=0x7000+((chch)&0x01ff)+512;
					counter++;
				}
				...
				else if (strcmp(token,"or")==0)
				{
					...
					op3 = strtok(NULL,"\n\t\r ");
					chch = (op1[0]-48)| ((op2[0]-48)<<6)|((op3[0]-48)<<3);
					program[counter]=0x7000+((chch)&0x01ff)+1536;
					counter++;
				}
				else if (strcmp(token,"xor")==0)
				{
					...
					op3 = strtok(NULL,"\n\t\r ");
					chch = (op1[0]-48)| ((op2[0]-48)<<6)|((op3[0]-48)<<3);
					program[counter]=0x7000+((chch)&0x01ff)+2048;
					counter++;
				}
				...
				else if (strcmp(token,"mov")==0)
				{
					...
					op2 = strtok(NULL,"\n\t\r ");
					ch = (op1[0]-48)| ((op2[0]-48)<<3);
					program[counter]=0x7e00+((ch)&0x003f)+64;
					counter++;
				}
				else if (strcmp(token,"inc")==0)
				{
					...
					program[counter]=0x7e00+((ch)&0x003f)+128;
					counter++;
				}
				else if (strcmp(token,"dec")==0)
				{
					op1 = strtok(NULL,"\n\t\r ");
					ch = (op1[0]-48)| ((op1[0]-48)<<3);
					program[counter]=0x7e00+((ch)&0x003f)+192;
					counter++;
				}
				else if (strcmp(token,"push")==0)
				{
					op1 = strtok(NULL,"\n\t\r ");
					chch = (op1[0]-48)<<6;
					program[counter]=0x8000+((chch)&0x01ff);
					counter++;
				}
				else if (strcmp(token,"pop")==0)
				{
					op1 = strtok(NULL,"\n\t\r ");
					chch = (op1[0]-48);
					program[counter]=0x9000+((chch)&0x000f);
					counter++;
				}
